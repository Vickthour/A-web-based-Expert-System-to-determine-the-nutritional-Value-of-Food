        ...
        <div class="container">
          <div class="navbar-header">
            ...
            <span class="icon-bar"></span>                        
                    ...
                    <a  class="navbar-brand" href="chat.php?user=<?php echo $_SESSION['email'] ?>"><strong><span class="glyphicon glyphicon-user"></span> Welcome <?php echo $_SESSION['email']; ?></a>
               </div>
                    <div class="collapse navbar-collapse" id="myNavbar">
        
                        <ul class="nav navbar-nav">
                            <li><a href="services.php"><strong><i class="glyphicon glyphicon-cog"></i> Cancel Chat</strong></a></li>
                        </ul>
        ...
        <!-- chat box -->
                <div class="col-sm-4 col-sm-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-heading contents" align="center" style=""    >
                           
                        </div>  
                        <div id="response padding-body"></div>
                        <form class="panel-footer" method="POST">
                            <div class="form-group">
                                <textarea class="form-control" id="msg" rows="3" name="msg" placeholder="Enter your message..." style="resize:none;"></textarea>
                            </div>
                            <button type='submit' class='btn btn-success' id='send' name="send"><i class="glyphicon glyphicon-send"></i> Send</button>    
                        </form>
